...
import { CronJob } from '@bot/structures/modules/cron-job';
import moment from 'moment-timezone';
import { Collection, Snowflake, TextChannel } from 'discord.js';

import json from '@bot/json/reminders.json';
import { JSONDeclaration, Schedule, Day } from '@bot/typings/reminders';
